...
const images = {
  hero: assetPath("bia3.png"),
  aboutFeature: assetPath("lhpvg.png"),
  aboutPortrait: assetPath("lhpav.png"),
  setupMain: assetPath("lhpmain.jpg"),
  setupLaptop: assetPath("lhp1.png"),
  setupCreative: assetPath("Rectangle-26604@2x.png"),
  setupWorkspace: assetPath("lhp2.png"),
};
      ...
      <motion.section
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 text-center px-4">
          ...
          <motion.p
            ...
            style={{ textShadow: '0 0 14px rgba(0,0,0,0.35)' }}>
          ...
          <motion.p
            ...
            className="text-[clamp(14px,1.5vw,26px)] font-light text-[#f8f2d5] mt-4"
            style={{ textShadow: '0 0 10px rgba(0,0,0,0.35)' }}>
          ...
          <div className="flex flex-col gap-8">
            <motion.div
              ...
              <p className="text-[clamp(16px,1.3vw,22px)] font-normal leading-[1.7] text-primary">
                Tôi là <strong>Lê Hoàng Phúc</strong>, sinh viên ngành <strong>Ngôn ngữ và Văn hóa Trung Quốc</strong>, ULIS-VNU. 
                Tôi đam mê văn hóa Trung Quốc và luôn tìm tòi, học hỏi những công nghệ mới để phát triển bản thân mỗi ngày.
              </p>
              <p className="text-[clamp(16px,1.3vw,22px)] font-normal leading-[1.7] text-primary">
                Sở thích của tôi bao gồm: học thư pháp, đọc sách về phát triển bản thân và chụp ảnh.
              </p>
            </motion.div>
      ...
      <section className="mt-[clamp(38px,7.8vw,150px)] bg-secondary py-[20px] overflow-clip flex relative z-10">
        <motion.div
          ...
          <div key={i} className="flex flex-col items-center gap-1.5 w-20 shrink-0">
              ...
              <p className="text-[clamp(14px,1.3vw,25px)] font-bold text-white">{skill.name}</p>
            </div>
          )}
        </motion.div>
      </section>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                  ...
                  <div className="flex flex-col gap-2 md:gap-4 text-center md:text-left">
                    <p className="text-[clamp(22px,2.08vw,40px)] font-bold text-primary">Lê Hoàng Phúc</p>
                    ...
                    <p className="text-[14px] md:text-[18px] font-bold text-primary">Sinh viên Ngôn ngữ và Văn hóa Trung Quốc · Năm 1 · ULIS-VNU</p>
                  </div>
                </div>
              </div>
          ...
          <motion.div
            ...
            className="flex flex-col rounded-[20px] overflow-hidden shadow-[inset_0_0_0_1px_#f8f2d5] bg-[#f8f2d5]/5 hover:bg-[#f8f2d5]/10 transition-all duration-300 group">
              ...
              <div className="p-6 flex flex-col gap-4 flex-1">
                ...
                <span key={j} className="py-1 px-3 rounded-full shadow-[inset_0_0_0_1px_hsl(var(--secondary))] text-[12px] font-bold text-secondary">
                      {tag}
                    </span>
                )}
                </div>
  ...
  {tag}</span>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1220fr_582fr] gap-[clamp(16px,2.6vw,50px)] xl:gap-[clamp(20px,5.2vw,100px)]">
          ...
          <motion.div
            ...
            <form className="flex flex-col gap-[23px] w-full" onSubmit={(e) => e.preventDefault()}>
              ...
              <button type="submit" className="flex flex-row items-center gap-[11px] p-4 md:p-5 bg-secondary rounded-[58px] w-fit hover:scale-105 transition-transform mt-4">
                ...
                <span className="text-[16px] md:text-[20px] font-semibold text-white">Gửi tin nhắn</span>
              </button>
            </form>
          </motion.div>
          ...
          <motion.div
            ...
            <div className="flex flex-col gap-[21px]">
              ...
              <a href="mailto:mauxanh3105@gmail.com" className="text-[clamp(16px,1.8vw,32px)] font-normal hover:text-secondary transition-colors break-all">mauxanh3105@gmail.com</a>
              <p className="text-[clamp(14px,1.5vw,24px)] font-normal text-[#f8f2d5]/80">0961281686</p>
            </div>
      ...
      <footer className="mt-[clamp(38px,7.8vw,150px)] mx-4 md:mx-12 mb-12 flex flex-col lg:flex-row justify-between items-center gap-10 z-10 relative border-t border-[#f8f2d5]/20 pt-10">
        <div className="flex flex-row items-center gap-[clamp(16px,2.1vw,40px)] md:gap-[clamp(19px,4.9vw,95px)]">
          ...
          <p className="text-[clamp(20px,2.34vw,45px)] font-extrabold">Hoàng Phúc</p>
        </div>
